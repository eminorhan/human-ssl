...
from utils import train, set_seed, validate, adjust_learning_rate

parser = argparse.ArgumentParser(description='ImageNet fine-tuning or linear classification')
parser.add_argument('--imgnet-traindir', default='/scratch/work/public/imagenet/train', type=str, help='path to ImageNet train set')
parser.add_argument('--imgnet-valdir', default='/scratch/eo41/imagenet/val', type=str, help='path to ImageNet validation set')
...
parser.add_argument('--print-freq', default=625, type=int, help='print frequency (default: 5000)')
...
def main():
    ...
    # Save file name
    savefile_name = 'ImageNet_{}_{}_{}_{}.tar'.format(args.resume, args.freeze_trunk, args.frac_retained, args.seed)
    ...
    val_dataset = datasets.ImageFolder(args.imgnet_valdir, transforms.Compose([
